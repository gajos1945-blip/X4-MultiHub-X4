...
ENV = "gh_release"
RELEASE_NAME = "X4_MultiHub_X4_v1.3-dev.bin"
...
def main() -> int:
    ...
    manifest = {
        ...
        "release_status": "DEVELOPMENT_V1_3_HARDWARE_UNVERIFIED",
    ...
    (dist / "DEV_STATUS.txt").write_text(
        "X4 MultiHub v1.3-dev\n"
        "TIME / NTP / TODAY DEVELOPMENT MILESTONE\n"
    ...
    print("BIN:", final_bin)
    print("SHA-256:", sha)
    print("Milestone: Time / NTP / Today v1.3-dev")
